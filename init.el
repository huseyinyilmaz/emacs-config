...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (vcl-mode org-mind-map kubernetes flycheck-mypy ox-gfm magit which-key company-restclient restclient move-text ace-jump-mode helm-ag helm-swoop helm-projectile helm-flycheck helm aggressive-indent highlight-indentation whitespace-cleanup-mode hl-sexp elisp-slime-nav smart-mode-line-powerline-theme smart-mode-line powerline gruvbox-theme atom-dark-theme spacegray-theme base16-theme monokai-theme solarized-theme zenburn-theme dracula-theme jdee company-tern tern coffee-mode scss-mode sass-mode yaml-mode json-mode csv-mode intero ensime yasnippet web-mode virtualenvwrapper slime rainbow-delimiters projectile multiple-cursors git-gutter-fringe flycheck-color-mode-line exec-path-from-shell company-anaconda ag)))
